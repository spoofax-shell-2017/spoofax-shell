 ...
 */
public class AEvalFunction extends AbstractFunction<AnalyzeResult, EvaluateResult> {
    ...
    @Override
    public EvaluateResult valid(AnalyzeResult arg) throws MetaborgException {
    ...
    @Override
    public EvaluateResult invalid(AnalyzeResult arg) {
        // FIXME:
        return null;
    }
}
